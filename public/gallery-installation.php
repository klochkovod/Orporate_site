  ...
  <section class="all-gallery">
    <div class="container">
      ...
      <div class="row">
        ...
        $limit_page = 5;
        $limit = 12;
        $result=$induction->query("SELECT COUNT(*) as count FROM `gallery-installation`");
        ...
        $offset = $limit * ($page - 1);
        $result=$induction->query("select * from `gallery-installation` order by `id` desc limit $limit offset $offset");
