...
<head>
  ...
  <title>«Пласт Декор» - Проектирование</title>
  ...
  <section class="all-gallery">
    <div class="container">
      ...
      <div class="row">
        ...
        $limit_page = 5;
        $limit = 12;
        $result=$induction->query("SELECT COUNT(*) as count FROM `gallery-design`");
        ...
        $offset = $limit * ($page - 1);
        $result=$induction->query("select * from `gallery-design` order by `id` desc limit $limit offset $offset");
